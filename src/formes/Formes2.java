...
public class Formes2 {
    ...
    public static void main(String[] args) {
        ...
        // On les mets dans un tableau d'objets (rappel : en Java tout objet créé est
        // également un Object)
        ...
        // On se promène dans le tableau et, selon avec qui on a à faire, on affiche qui
        // c'est et sa surface
        for (int i = 0; i < mesFormes.length; i++) {
            ...
            // Y en a-t-il un ?
            if (maForme != null) {
                // Pas besoin de connaître "à qui avons-nous à faire" vu qu'au minimum c'est une
                // forme
                maForme.sePresenter();
